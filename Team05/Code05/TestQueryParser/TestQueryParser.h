...
class QueryParserTest : public CPPUNIT_NS::TestFixture{ 
	...
	CPPUNIT_TEST(testQueryPattern3);
	CPPUNIT_TEST(testQueryPattern4);
	CPPUNIT_TEST(testQueryPattern5);
	CPPUNIT_TEST(testQueryPattern6);
	CPPUNIT_TEST(testQueryPattern7);
	...
	CPPUNIT_TEST(testQuerySibling1);
	CPPUNIT_TEST(testQuerySibling2);
	...
	CPPUNIT_TEST(testQueryValidationPattern4);
...
public:
	...
	void testQueryPattern3();
	void testQueryPattern4();
	void testQueryPattern5();
	void testQueryPattern6();
	void testQueryPattern7();
	...
	void testQueryWith5();
	void testQueryWith6();
	void testQuerySibling1();
	void testQuerySibling2();
	...
	void testQueryValidationPattern4();
