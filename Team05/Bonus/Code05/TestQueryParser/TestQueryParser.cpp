...
void QueryParserTest::testQueryParent1(){
	//INIT BEGIN
	...
	//expected relationship
	vector<Relationship> expectedRelVect;
	expectedRelVect.push_back(Relationship("Parent","s",Relationship::SYNONYM,"6",Relationship::INTEGER));
	//assert relationship
	for(int i=0;i<(int)expectedRelVect.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getRelType(),relVect[i].getRelType());
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getPatternSyn(),relVect[i].getPatternSyn());
...
void QueryParserTest::testQueryPattern3(){
	//INIT BEGIN
	string query = "assign a1; prog_line n1;Select n1 pattern a1(_,_\"(a-(b+c)*d)\"_)";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
	...
	//expected selected syn
	vector<string> expectedSelectedSyn;
	expectedSelectedSyn.push_back("n1");
	//assert selected syn
	for(int i=0;i<(int)expectedSelectedSyn.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedSelectedSyn[i],selectedSyn[i]);
	}
	...
	expectedSynTable.insert(make_pair("BOOLEAN", TypeTable::BOOLEAN));
	expectedSynTable.insert(make_pair("a1", TypeTable::ASSIGN));
	expectedSynTable.insert(make_pair("n1", TypeTable::PROGLINE));
	unordered_map<string, TypeTable::SynType>::iterator expectedIter;
	expectedIter= expectedSynTable.begin();
	//assert syn table
	for(int i=0;i<expectedSynTable.size();i++){
	...
	//expected relationship
	vector<Relationship> expectedRelVect;
	expectedRelVect.push_back(Relationship("pattern","a1","_",Relationship::UNDERSCORE,"_\"(a-(b+c)*d)\"_",Relationship::UNDERSCOREEXPR));
	//assert relationship
	for(int i=0;i<(int)expectedRelVect.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getRelType(),relVect[i].getRelType());
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getPatternSyn(),relVect[i].getPatternSyn());
...
void QueryParserTest::testQueryPattern4(){
	//INIT BEGIN
	string query = "assign a1; prog_line n1;Select n1 pattern a1(_,_\"(b-c)+(d*2)\"_) with n1=1";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
	...
	//expected relationship
	vector<Relationship> expectedRelVect;
	expectedRelVect.push_back(Relationship("pattern","a1","_",Relationship::UNDERSCORE,"_\"(b-c)+(d*2)\"_",Relationship::UNDERSCOREEXPR));
	expectedRelVect.push_back(Relationship("with","n1",Relationship::SYNONYM,"1",Relationship::INTEGER));
	//assert relationship
	for(int i=0;i<(int)expectedRelVect.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getRelType(),relVect[i].getRelType());
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getPatternSyn(),relVect[i].getPatternSyn());
...
void QueryParserTest::testQueryPatternWhile1(){
	...
	//expected relationship
	vector<Relationship> expectedRelVect;
	expectedRelVect.push_back(Relationship("pattern","a","\"y\"",Relationship::IDENTIFIER,"_",Relationship::UNDERSCORE));
	//assert relationship
	for(int i=0;i<(int)expectedRelVect.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getRelType(),relVect[i].getRelType());
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getPatternSyn(),relVect[i].getPatternSyn());
...
void QueryParserTest::testQueryWith4(){
	...
	vector<Relationship> expectedRelVect;
	expectedRelVect.push_back(Relationship("Follows*","n",Relationship::SYNONYM,"s",Relationship::SYNONYM));
	Relationship expected2("with","c",Relationship::SYNONYM,"\"First\"",Relationship::IDENTIFIER);
	expected2.setCallSynType(TypeTable::PROCEDURE);
	expectedRelVect.push_back(expected2);
	//assert relationship
	for(int i=0;i<(int)expectedRelVect.size();i++){
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getRelType(),relVect[i].getRelType());
		CPPUNIT_ASSERT_EQUAL(expectedRelVect[i].getPatternSyn(),relVect[i].getPatternSyn());
...
void QueryParserTest::testQueryWith5(){
	//INIT BEGIN
	string query = "procedure p; stmt s; call c;Select s with c.procName=p.procName";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
...
void QueryParserTest::testQuerySibling1(){
	//INIT BEGIN
...
void QueryParserTest::testQuerySibling3(){
	//INIT BEGIN
	string query = " stmt s; stmtLst p;Select s such that Sibling(s,p)";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
	...
	expectedSynTable.insert(make_pair("BOOLEAN", TypeTable::BOOLEAN));
	expectedSynTable.insert(make_pair("s", TypeTable::STMT));
	expectedSynTable.insert(make_pair("p", TypeTable::STMTLST));
	unordered_map<string, TypeTable::SynType>::iterator expectedIter;
	expectedIter= expectedSynTable.begin();
	//assert syn table
	for(int i=0;i<expectedSynTable.size();i++){
...
void QueryParserTest::testQueryMultipleWith2(){
	//INIT BEGIN
	string query = "prog_line n; stmt s; if f; while w; assign a; call c; Select s such that Follows*(n,s) with n=10 and s.stmt#=9 and s.stmt#=11 with f.stmt#=9 and w.stmt#=11 with a.stmt#=9 and c.stmt#=11 ";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
	...
	expectedSynTable.insert(make_pair("n", TypeTable::PROGLINE));
	expectedSynTable.insert(make_pair("s", TypeTable::STMT));
	expectedSynTable.insert(make_pair("f", TypeTable::IF));
	expectedSynTable.insert(make_pair("w", TypeTable::WHILE));
	expectedSynTable.insert(make_pair("a", TypeTable::ASSIGN));
	expectedSynTable.insert(make_pair("c", TypeTable::CALL));
	unordered_map<string, TypeTable::SynType>::iterator expectedIter;
	...
	expectedRelVect.push_back(Relationship("with","s",Relationship::SYNONYM,"9",Relationship::INTEGER));
	expectedRelVect.push_back(Relationship("with","s",Relationship::SYNONYM,"11",Relationship::INTEGER));
	expectedRelVect.push_back(Relationship("with","f",Relationship::SYNONYM,"9",Relationship::INTEGER));
	expectedRelVect.push_back(Relationship("with","w",Relationship::SYNONYM,"11",Relationship::INTEGER));
	expectedRelVect.push_back(Relationship("with","a",Relationship::SYNONYM,"9",Relationship::INTEGER));
	expectedRelVect.push_back(Relationship("with","c",Relationship::SYNONYM,"11",Relationship::INTEGER));
	//assert relationship
...
void QueryParserTest::testQueryValidationPatternWhile1(){
	string query = "while a; Select a pattern a (\"y\", \" 2 * x \")";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
...
void QueryParserTest::testQueryValidationPatternIf1(){
	string query = "if a; Select a pattern a (\"y\", _)";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
...
void QueryParserTest::testQueryValidationPatternIf2(){
	string query = "if a; Select a pattern a (\"y\", _  ,\"y\" )";
	QueryParser qp;
	bool isValid = true;
	Query parsedQuery = qp.queryParse(query,isValid);
